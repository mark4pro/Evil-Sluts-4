...
const this_table_1 = {
	0:new Sprite(1, new baseObject(false, new nameTag("dungeon_wall", "tile"), new Vector2(32, 32), new Vector2(), this_table_1_image_data[0].getColor(), new Shadow(new Vector2(32, 32), "rgba(0,0,0,0.5)", 0))),
